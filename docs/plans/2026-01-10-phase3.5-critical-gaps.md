...
uv run python -c "
from cards_evolve.genome.examples import create_hearts_genome
from cards_evolve.validation.schema_check import validate_genome
...
1. `src/cards_evolve/genome/schema.py` - Core types + extensions
2. `src/cards_evolve/genome/examples.py` - Hearts example
3. `src/cards_evolve/validation/schema_check.py` - Updated validation
4. `src/cards_evolve/evolution/fitness.py` - Fitness restructure
5. `src/cards_evolve/evolution/population.py` - Diversity mechanism
6. `src/cards_evolve/evolution/operators.py` - Win-condition mutation
7. `src/cards_evolve/evolution/engine.py` - Diversity monitoring
